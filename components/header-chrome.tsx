...
/** Interactive nav, locale switcher, auth slot, and mobile menu. */
export function HeaderChrome({ locale, children }: HeaderChromeProps) {
      ...
      >
        ...
        >
          ...
          <div className="border-text/8 mt-3 flex flex-wrap items-center gap-x-3 gap-y-2 border-t px-3 pt-4">
            ...
            <AuthStatus locale={locale} mobile />
          </div>
        </nav>
      </div>
    </>
